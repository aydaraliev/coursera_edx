...
```{r beta-ci}
qbeta(c(0.025, 0.975), shape1 = 2, shape2 = 5)
```
...
```{r}
qbeta(c(0.025, 0.975), shape1 = 500 + x, shape2 = 500+n-x)
```
...
```{r}
qbeta(c(0.025, 0.975), shape1 = 5 + x, shape2 = 200+n-x)
```
