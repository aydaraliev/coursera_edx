...
ggplot(nc, aes(x=weight)) + geom_histogram()
...
```{r}
bayes_inference(y = lowbirthweight, x = habit, data = nc, statistic = "proportion", success = "not low", type = "ht", null = 0, alternative = "twosided")
```
...
```{r}
bayes_inference(y = premie, x = habit, data = nc, statistic = "proportion", success = "full term", type = "ht", null = 0, alternative = "twosided")
```
