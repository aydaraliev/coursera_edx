...
samp %>% summarise(x_bar = mean(area))
```
...
convert_multiplier_upper = z_star_99/z_star_95
convert_multiplier_lower = 2 - convert_multiplier_upper


ci$lower = ci$lower*convert_multiplier_lower
ci$upper = ci$upper*convert_multiplier_upper
