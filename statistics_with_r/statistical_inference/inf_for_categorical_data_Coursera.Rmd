...
Success-Failure must be more than 10 samples.
...
uz12 <- atheism %>%
  filter(nationality == "Uzbekistan" , atheism$year == "2012")

inference(y = response, data = uz12, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")
...
inference(y = response, x = as.factor(year), data = esp, null = 0, statistic = "proportion", alternative = 'twosided', type = "ht", method = "theoretical", success = "atheist")
...
inference(y = response, x = as.factor(year), data = us, statistic = "proportion", null = 0, alternative = 'twosided', type = "ht", method = "theoretical", success = "atheist")
```
...
```{r type1}
length(unique(atheism$nationality))*0.05
