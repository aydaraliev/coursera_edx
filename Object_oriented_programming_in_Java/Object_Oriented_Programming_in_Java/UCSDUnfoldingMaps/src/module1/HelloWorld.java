...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		size(1200, 800, P2D);  // Set up the Applet window to be 800x600
		...
		map1 = new UnfoldingMap(this, 30, 30, 550, 700, provider);
		map2 = new UnfoldingMap(this, 600, 30, 550, 700, provider);

		// The next line zooms in and centers the map at 
	    // 32.9 (latitude) and -117.2 (longitude)
		// Bishkek 42.8746, 74.5698° E
	    map1.zoomAndPanTo(zoomLevel, new Location(32.9f, -117.2f));
	    map2.zoomAndPanTo(zoomLevel, new Location(42.8746f, 74.5698f));
