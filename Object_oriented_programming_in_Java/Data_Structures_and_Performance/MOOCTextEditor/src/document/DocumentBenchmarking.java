	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			 ...
			 */  
			 ...
			 long time_stop = System.nanoTime()-time_start;
			 System.out.print((double)time_stop/1000000000 + "\t");
			 long time_start_2 = System.nanoTime();
			 for (int i=0; i<trials; i++) {
				 EfficientDocument ed = new EfficientDocument(text);
				 ed.getFleschScore();
			 }
			 long time_stop_2 = System.nanoTime()-time_start_2;
			 System.out.println((double)time_stop_2/1000000000);
		}
